...
# VENDOR_EDIT : We do use old DT method
...
# VENDOR_EDIT : YU Platforms have a bootloader
...
# VENDOR_EDIT: Use our own partition sizes
...
# VENDOR_EDIT: Move partition FS here
...
# VENDOR_EDIT: Our platforms provides their own cmdline
ifneq ($(PRODUCT_BRAND),YU)
...
# VENDOR_EDIT: Don't compress the kernel
ifeq ($(PRODUCT_BRAND),YU)
